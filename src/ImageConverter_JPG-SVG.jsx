...
function ImageConverterJPEGtoSVG() {
    const [svgData, setSvgData] = useState(null);
    const [error, setError] = useState(null);
    const [isLoading, setIsLoading] = useState(false);

    const convertJPEGtoSVG = (file) => {
    ...
    const handleFileChange = async (event) => {
        ...
        if (file) {
            try {
                const svg = await convertJPEGtoSVG(file);
                setSvgData(svg);
            } catch (error) {
                ...
                <div className="col-md-6">
                    <div className="card shadow-lg">
                        <div className="card-body">
                            <h3 className="text-center mb-4">JPEG to SVG Converter</h3>
...
export default ImageConverterJPEGtoSVG;
